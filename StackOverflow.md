::: {#efde5a15-8fbd-49af-8118-4492aa7b3bc3 .cell .code id="efde5a15-8fbd-49af-8118-4492aa7b3bc3"}
``` python
import numpy as np
import pandas as pd
...
::: {#HLamVKwrva1v .cell .markdown id="HLamVKwrva1v"}
# Introduction

- The goal of this project is to predict developer salaries based on
  survey data from the Stack Overflow Developer Survey
- An important part of the project is data preprocessing and feature
  engineering, due to poor quality data and missing values
- The project also aims to investigate which features have the greatest
  impact on the salary
- Several machine learning models were evaluated, including Linear
...
:::: {#3a1f39d1-8ef6-43dc-9e31-680976e62c36 .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="3a1f39d1-8ef6-43dc-9e31-680976e62c36" outputId="fb2b67e3-6fc9-47fc-ebe1-033ede9d7ad5"}
``` python
...
:::: {#8096b6e4-5ad1-4a4a-923e-895e0b1c0541 .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="8096b6e4-5ad1-4a4a-923e-895e0b1c0541" outputId="99aa8cba-8ce8-41d6-86a9-3ec12c60cf6d"}
``` python
...
::: {#32c170ec-69e6-409f-8118-bdeace44d61b .cell .code id="32c170ec-69e6-409f-8118-bdeace44d61b"}
``` python
...
::: {#e2af37e3-ba50-4886-bf9c-263124bc234f .cell .code id="e2af37e3-ba50-4886-bf9c-263124bc234f"}
``` python
org_data = org_data.drop_duplicates()
```
:::

::: {#b1911f85-7f6e-4719-8f6b-ef1b2f8879f7 .cell .code id="b1911f85-7f6e-4719-8f6b-ef1b2f8879f7"}
``` python
...
:::: {#E1l-OrjNiOes .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="E1l-OrjNiOes" outputId="3b5698dc-f674-404e-98c6-f672c53bb047"}
``` python
...
::: {#96801167-04ff-42e9-b587-91cad973cb7b .cell .code id="96801167-04ff-42e9-b587-91cad973cb7b"}
``` python
org_data = org_data.drop(columns='AIModelsHaveWorkedWith',axis=1)
```
:::

:::: {#d33a63f1-e3ae-4394-8000-1247f66aa2ed .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="d33a63f1-e3ae-4394-8000-1247f66aa2ed" outputId="7e50ee66-e8a4-4a60-f67f-98ec5145ee3e"}
``` python
org_data.info()
```
...
:::: {#d38b7acf-a12d-46c8-9b09-ac5287716e3e .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="d38b7acf-a12d-46c8-9b09-ac5287716e3e" outputId="05909d64-c68d-41d3-b600-2b4dedf522b4"}
``` python
org_data.head()
```
...
::: {#9e1891b3-00d2-450d-b2bf-7cc95a67f631 .cell .code id="9e1891b3-00d2-450d-b2bf-7cc95a67f631"}
``` python
...
:::: {#b337a61d-c102-419a-b50c-3f9b0cef63c6 .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="b337a61d-c102-419a-b50c-3f9b0cef63c6" outputId="a56be599-a001-490e-d441-9f7f4b50185b"}
``` python
org_data.head()
```
...
:::: {#ab81d71e-7507-4401-9866-fcbdd99820a7 .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="ab81d71e-7507-4401-9866-fcbdd99820a7" outputId="38664f2e-f434-4b28-f8a6-c4beb76ce890"}
``` python
...
::: {#2f7be4c7-2e66-48ee-bd0c-254edaba209d .cell .code id="2f7be4c7-2e66-48ee-bd0c-254edaba209d"}
``` python
...
:::: {#1a5db8fd-b242-4436-aa77-76bf7a071d33 .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="1a5db8fd-b242-4436-aa77-76bf7a071d33" outputId="add366d5-18b1-4bfe-ef0d-7188e441c5ff"}
``` python
org_data.head()
```
...
::: {#abca9af9-b9b1-4053-8383-af91ea1c65cc .cell .code id="abca9af9-b9b1-4053-8383-af91ea1c65cc"}
``` python
age_order = {
    '25-34 years old':0,
    '35-44 years old':1,
...
::: {#d7a82dbc-68bd-4ed4-9f43-144cbc88b927 .cell .code id="d7a82dbc-68bd-4ed4-9f43-144cbc88b927"}
``` python
data = org_data.copy()
...
::: {#e1b79db2-3261-497f-844b-25ff8c91fe1b .cell .code id="e1b79db2-3261-497f-844b-25ff8c91fe1b"}
``` python
...
:::: {#c34834d6-5847-4103-bb93-f5bdcd6e77ec .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="c34834d6-5847-4103-bb93-f5bdcd6e77ec" outputId="9c9f4144-d66f-4dc3-e825-37a9e0263621"}
``` python
data.head()
```
...
::: {#85404384-a043-4487-a0e0-8c5fb18bee64 .cell .code id="85404384-a043-4487-a0e0-8c5fb18bee64"}
``` python
...
::: {#84274ee4-bdee-46f5-9af0-8d3baf468892 .cell .code id="84274ee4-bdee-46f5-9af0-8d3baf468892"}
``` python
...
::: {#df89fa60-110b-453f-a993-9f33f0470fc4 .cell .code id="df89fa60-110b-453f-a993-9f33f0470fc4"}
``` python
...
:::: {#9322edbd-ba64-40a0-a138-2d84435e9fc3 .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="9322edbd-ba64-40a0-a138-2d84435e9fc3" outputId="c2aeee30-cf41-4c5c-92db-0da85a0e5668"}
``` python
data.info()
```
...
::: {#2e709b41-f28c-42c4-bb90-a6883b8ac2e4 .cell .code id="2e709b41-f28c-42c4-bb90-a6883b8ac2e4"}
``` python
...
:::: {#10219ae2-af29-4748-9467-6df0b594e728 .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="10219ae2-af29-4748-9467-6df0b594e728" outputId="78186f97-5576-414e-da33-dce703220bb2"}
``` python
data.head()
```
...
:::: {#D1NqIPQfdcCP .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="D1NqIPQfdcCP" outputId="b2747f0d-6c37-43a1-b465-cc066ff57fa2"}
``` python
...
:::: {#2fc136c0-37af-4813-bd8e-5848085d410b .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="2fc136c0-37af-4813-bd8e-5848085d410b" outputId="c1675680-e4b7-4297-ae09-2384e472563b"}
``` python
...
- **right-skwed distribiution: most people earn low salary, only a small
  number have high income**
...
:::: {#9NQo906c9IA- .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="9NQo906c9IA-" outputId="a19a75cd-95e6-4681-c9d2-3506be96e389"}
``` python
...
- **clear upward trend (strong positive correlation): salary increses
  with age**
- **the highest difference is between age groups: 18-24 and 25-34 years
  old due to career progression**
...
:::: {#PofYZfkJFLAL .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="PofYZfkJFLAL" outputId="b5727c0a-9e7c-4f1e-ff26-abedfca8c646"}
``` python
plt.figure(figsize=(15,5))
...
:::: {#cXTh6ERyY1oJ .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="cXTh6ERyY1oJ" outputId="026ea286-ddc4-4935-d573-49f2b9378a3c"}
``` python
...
:::: {#mDcuKP2_r5wj .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="mDcuKP2_r5wj" outputId="b50d251e-aad0-495a-9901-70e6d8261598"}
``` python
plt.figure(figsize=(15,5))
...
- **there is a positive relationship between work experience and salary,
  especially during the first 10 years**
- **between 1st and 10th year median salary tripples, reflecting carrer
  growth**
...
::: {#jiCA_H7vw2e0 .cell .code id="jiCA_H7vw2e0"}
``` python
...
:::: {#FSKrw0T_yvUo .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="FSKrw0T_yvUo" outputId="337f11c3-0a82-433e-d498-937798ff9b84"}
``` python
plt.figure(figsize=(15,5))
...
:::: {#e18TuD2nhHcY .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="e18TuD2nhHcY" outputId="4c8f8325-eeff-415f-a42c-82cf686206e2"}
``` python
filtered
```
...
- **the highest salaries are observed for professional and master\'s
  degrees**
- **people with a Bachelor\'s degree earn about 18k more than those with
  secondary school education, while those with a Professional degree
  earn almost \$30k more**
:::

:::: {#14611c84-756e-42f3-b77b-6c79749b57e2 .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="14611c84-756e-42f3-b77b-6c79749b57e2" outputId="55852c60-3d33-4b96-ac9f-3e12ac485069"}
``` python
...
:::: {#4c674674-e660-438a-b72e-489ab2300c9b .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="4c674674-e660-438a-b72e-489ab2300c9b" outputId="8d23d8f4-7fe5-4cd0-b86c-1d6111314ec2"}
``` python
...
:::: {#81e52fb5-3fdf-4f0c-a316-bc72c5a0ca6d .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="81e52fb5-3fdf-4f0c-a316-bc72c5a0ca6d" outputId="1afdf57d-404a-4354-ec69-b4e55b42a2ce"}
``` python
...
:::::: {#5dda12ee-132a-423d-a8e9-00397d9f2584 .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="5dda12ee-132a-423d-a8e9-00397d9f2584" outputId="c10b0ce3-41dd-41b4-b47e-16c7294ff579"}
``` python
...
- **years of coding experience (YearsCode) and work experience (WorkExp)
  are higly correlated (\~0.39 and \~0.36), suggesting that more
  experience leads to higher salaries. However, these two variables
  might be higly correlated, which has to be checked to avoid
...
:::::: {#8fdd1550-70e6-433a-855b-8cde719e632d .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="8fdd1550-70e6-433a-855b-8cde719e632d" outputId="be61732a-c3e5-46ba-c2f9-d51d176b939d"}
``` python
...
- **other variables show relatively low correlations, which suggests
  they have less consistent impact on salary compared to mentioned above
  features**
:::

:::: {#19cf903f-a6c4-4928-b6e5-dced7398aa60 .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="19cf903f-a6c4-4928-b6e5-dced7398aa60" outputId="245b6215-d9fd-452b-fcfa-794cff726dc0"}
``` python
...
::: {#8ca328b9-9786-4266-b8bb-ca0d1e2780c0 .cell .code id="8ca328b9-9786-4266-b8bb-ca0d1e2780c0"}
``` python
...
::: {#a6ySqS4Avk_Y .cell .code id="a6ySqS4Avk_Y"}
``` python
from sklearn.dummy import DummyRegressor
```
:::

:::: {#f3bf30ad-4a20-4e66-9c07-c99b7bcf7d21 .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="f3bf30ad-4a20-4e66-9c07-c99b7bcf7d21" outputId="450210cf-ff48-4f38-a6fd-56045372bbbe"}
``` python
...
::: {#xLPx7_R1j0AG .cell .code id="xLPx7_R1j0AG"}
``` python
results = pd.DataFrame(columns=['Model','R2 train','R2 test', 'MAE test','RMSE test'])
```
:::

::: {#DyktvNw1lRzL .cell .code id="DyktvNw1lRzL"}
``` python
...
::: {#BAGPdjwDiUyY .cell .code id="BAGPdjwDiUyY"}
``` python
...
::: {#ZcL8UduTlxwn .cell .code id="ZcL8UduTlxwn"}
``` python
...
:::: {#aGpUs_egvnBz .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="aGpUs_egvnBz" outputId="d064ebc8-eb7b-4d5b-b5f3-c380cc3f7776"}
``` python
...
:::: {#fac2c98a-40d1-43a4-96e8-858b13d26bf2 .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="fac2c98a-40d1-43a4-96e8-858b13d26bf2" outputId="62f29dd0-e067-4cba-a41d-3818da046d1b"}
``` python
...
::: {#9aebe6c9-d0ca-4fb2-a8e2-70d84855b95d .cell .code id="9aebe6c9-d0ca-4fb2-a8e2-70d84855b95d"}
``` python
df_coef = pd.DataFrame(np.round(model.coef_,2),index= X.columns, columns=['Coef'])
```
:::

:::: {#eacd63b9-fa53-4030-ba90-3c3a156a1b64 .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="eacd63b9-fa53-4030-ba90-3c3a156a1b64" outputId="4c752287-874b-4c99-ebdb-19370e4b8079"}
``` python
...
- **the second top-tier countries for salary are Canada, Netherlands and
  Germany (42-57k \$)**
...
:::: {#78a031fa-2738-4f91-8e59-34f80168443e .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="78a031fa-2738-4f91-8e59-34f80168443e" outputId="3bc01ec2-0305-452c-be72-f20bc8287a60"}
``` python
...
- **several technologies (such as MySQL, jQuery, Express, HTML/CSS) have
  negative coefficients, suggesting they are more common in lower-paying
  roles**
...
- **the negative impact of age on salary might be due to higher
  proportion of younger respondents in the data, who typically earn less
...
::: {#BneKm-fQ2Q7G .cell .code id="BneKm-fQ2Q7G"}
``` python
from sklearn.ensemble import GradientBoostingRegressor
```
:::

:::: {#805fgAyQ2ST2 .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="805fgAyQ2ST2" outputId="794b621b-6684-441e-8602-9e6e46920596"}
``` python
...
::: {#80dEoBGa30eu .cell .code id="80dEoBGa30eu"}
``` python
from sklearn.model_selection import GridSearchCV
```
:::

::: {#4y5LaIQH37Fs .cell .code id="4y5LaIQH37Fs"}
``` python
...
::: {#chgy-9yIUhZ2 .cell .code id="chgy-9yIUhZ2"}
``` python
...
:::: {#2IQFQUEXU2Xf .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="2IQFQUEXU2Xf" outputId="62125104-00fe-4e63-fa33-88f9ec856372"}
``` python
...
::::: {#jpChdhDoxVTE .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="jpChdhDoxVTE" outputId="9e2f603e-0ba3-4cfe-cb4f-909ad6a4f37c"}
``` python
...
::: {#JQAZZnNP7j1n .cell .code id="JQAZZnNP7j1n"}
``` python
from sklearn.ensemble import RandomForestRegressor
```
:::

::: {#OTNm_U0g8A6V .cell .code id="OTNm_U0g8A6V"}
``` python
...
:::: {#rQhE6icg7mD1 .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="rQhE6icg7mD1" outputId="bcd5e01f-4ae8-4df6-ec61-b6a22eeb6812"}
``` python
...
::::: {#9MtfG_6LUfjZ .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="9MtfG_6LUfjZ" outputId="fdae6068-58d0-4817-98ff-fcad04f6b977"}
``` python
...
- **7 out of the top 20 features are location-based, indicating a strong
...
:::: {#P0OO0HFeZ5vN .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="P0OO0HFeZ5vN" outputId="71457653-1bf3-4187-9c8f-d6a9ed4d3a4f"}
``` python
...
:::: {#bLM7Nxwno-LN .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="bLM7Nxwno-LN" outputId="59e33085-3c84-4f79-abb0-3981648eee0f"}
``` python
...
:::: {#8pviF9VX1qlw .cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="8pviF9VX1qlw" outputId="cb47d223-0d02-4bbf-c264-236d8409237c"}
``` python
...
- **The best performing model was the Gradient Boost Regressor with Grid
  Search, as it achieved the highest R2 scores and the lowest errors
  (MAE \~29k \$)**
...
- **Linear Regression showed the weakest performance among the tested
  models (excluding the baseline), suggesting that the relationships in
...
- **the analysis showed that the most important factors influencing
  ...
  and years of professional experience. Other variables, such as company
  size, have a noticeably smaller impact on salary levels**
- **among the tested models, the best performance was achieved by the
  Gradient Boosting Regressor combined with Grid Search, which resulted
  in the highest predictive accuracy and the lowest error metrics**
- **other models had worse performence due to non-linear data (Linear
  Regression) or overfitting - achieving better results on trained than
  unseen data (Random Forest)**
- **limitations: noisy data, the data is dominated by respondents with
  lower to mid-level salaries, resulting in a skewed salary distribution
  and limited representation of high earners. This makes accurate
  prediction of extreme salary values more difficult**
